...
const PreparationScreen: React.FC = () => {
    ...
    return (
        <div className="flex-1 h-full overflow-y-auto no-scrollbar bg-zen-bg pb-32">
            {/* Header */}
                ...
                <div className="px-6">
                    <div className="relative overflow-hidden rounded-pebble bg-gradient-to-br from-[#ffffff] to-[#f4f2ef] shadow-mist p-8 border border-white/60">
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                            <p className="text-sm tracking-widest text-zen-text-light mb-1 font-light">距離{trip?.theme?.appLabel || trip?.title || '出發'}</p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="rounded-pebble bg-[#ebf2f5]/50 p-5 flex flex-col justify-between aspect-[1.1] active:bg-[#ebf2f5] transition-colors duration-500">
                            <div className="flex justify-between items-start">
                                ...
                                <span className="text-[10px] font-bold text-zen-blue/60 tracking-widest">{trip?.theme?.shortName || trip?.title || ''}</span>
                            </div>
                            <div>
                        ...
                        <div className="rounded-pebble bg-[#f5f2eb]/50 p-5 flex flex-col justify-between aspect-[1.1] active:bg-[#f5f2eb] transition-colors duration-500">
                            ...
                            <div>
                                <p className="text-3xl font-light text-zen-text mb-1">{trip?.exchange_rate ?? '—'}</p>
                                <p className="text-[10px] text-zen-text-light tracking-wider">TWD : {trip?.currency || '—'}</p>
                            </div>
                        </div>
                    </div>
                </div>
