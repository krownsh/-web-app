...
const BottomNav: React.FC<BottomNavProps> = ({ activePath }) => {
  ...
  return (
    <div className="fixed bottom-6 left-6 right-6 z-50 max-w-[400px] mx-auto">
      <div className="kit-nav bg-zen-moss/85 backdrop-blur-md border border-white/20 rounded-full shadow-[0_20px_40px_-12px_rgba(107,142,136,0.6)] h-[72px] flex items-center justify-between px-6 transition-all duration-300 active:bg-zen-moss/90 active:-translate-y-0.5 ring-1 ring-white/10">
        {navItems.map((item) => {
