...
export const SPOT_IMAGES: Record<string, string> = {
    ...
    'Grab 前往飯店': '/spots/citadines.webp',
    'Citadines 入住': '/spots/citadines.webp',
    '前往 Greenbelt Mall': '/spots/greenbelt.jpg',
    '晚餐 Manam': '/spots/manam.webp',
    'Greenbelt 散步回飯店': '/spots/greenbelt.jpg',
    '集合 Grab 往 Intramuros': '/spots/intramuros.webp',
    '王城區': '/spots/intramuros.webp',
    ...
    '海灣晚餐': '/spots/moa.jpg',
    '回飯店': '/spots/citadines.webp',
    'Legazpi Sunday Market': '/spots/legazpi-sunday-market.jpg',
    '回飯店整理行李': '/spots/citadines.webp',
    'Check-out': '/spots/citadines.webp',
